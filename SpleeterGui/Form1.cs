...
namespace SpleeterGui
{
    public partial class Form1 : Form
    {
        ...
        private void run_NIStem(String args)
        {
            ...
            args = "create -x " + (char)34 + txt_output_directory.Text + @"\" + current_songname + " - mix.wav" + (char)34 + " -s " +
        ...
        {
            //ALBUM COVER
            String args = "-y -i " + (char)34 + filename + (char)34 + " " + (char)34 + txt_output_directory.Text + @"\" + current_songname + ".jpg" + (char)34;
        ...
        {
            //ALBUM COVER
            String args = "-y -i " + (char)34 + filename + (char)34 + " -f ffmetadata " + (char)34 + txt_output_directory.Text + @"\" + current_songname + ".txt" + (char)34;
        ...
        private void run_ffmpegAudio(String filename)
        {
            ...
            String args = "-y -i " + (char)34 + filename + (char)34 + " " + (char)34 + txt_output_directory.Text + @"\" + current_songname + " - mix.wav" + (char)34;
    ...
    public partial class Form1 : Form
    {
        ...
        private void next_song()
        {
            ...
            if (files_remain > 0)
            {
                ...
                if (chkNIStem.Checked == true)
                {
                    processStartInfo = new ProcessStartInfo(pyPath, @" -W ignore -m spleeter separate  -o " + (char)34 + txt_output_directory.Text + @"\" + current_songname + (char)34 + " -d " + (duration.Value).ToString() + " -p " + (char)34 + storage + @"\config.json" + (char)34 + " -c " + cmbBox_codec.GetItemText(cmbBox_codec.SelectedItem) + " -f " + (char)34 + "{filename} - {instrument}.{codec}" + (char)34 + " " + (char)34 + filename + (char)34);
                }
